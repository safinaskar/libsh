...
В libsh есть ещё очень много того, что не описано в этом README. Всё это находится в других файлах, например, в `etc.c`, просто на данный момент плохо документировано.
