...
/// sh_x_write возвращает ssize_t, а не size_t, хоть size_t был бы и логичнее. Я всегда возвращаю либо то же, либо void в x-функциях. Тем не менее, sh_easy_getdelim возвращает size_t, т. к. он не относится к функциям с одним "x"
/// C vs C++ statement
